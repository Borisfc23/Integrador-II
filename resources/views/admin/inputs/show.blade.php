...
<div class="card">
    <div class="card-header">                
        ...
        <div class="form-group">
            ...
            {!! Form::text('factura',  $input->factura,['class'=>'form-control','placeholder'=>'Enter factura name','disabled ']) !!}
            @error('factura')
                <span class="text-danger">{{$message}}</span>    
            @enderror
        </div>
        ...
        <div>
            ...
            <a href="{{ route('admin.inputs.index')}}" class="btn btn-warning btn-lg float-right mx-3">Back</a>    
        </div>        
    </div>
    <div class="card-body">
